...
<body align="center">
    ...
    <div class="row justify-content-center my-4 text-center">
        <div class="col-4 mb-4">
            <div class="card">
                <img src="../imagenes_productos/<?php echo $row['archivo_productos'] ?>" class="card-img-top" style="height:300px; width:300px;">
                <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Vacantes disponibles: <?php echo $row['stock'] ?></li>
                </ul>
            </div>
            <a href="productos_lista.php" class="btn btn-primary mt-4">Regresar al listado</a>
        </div>
    </div>
